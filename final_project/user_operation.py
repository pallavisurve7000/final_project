...
class user_operation:
    ...
    def load_food_items(self):
            with open(r'C:\edyoda pr\final_project\food_item.json', 'r') as file:
                self.data= json.load(file)
    def write_food_items(self,data):
        with open(r'C:\edyoda pr\final_project\order_history.json','w') as addfile:
    ...
    def placeOrder(self):
       ...
       if not self.selected_items:
            ...
            with open(r'C:\edyoda pr\final_project\order_history.json','r') as file:
    ...
    def updateProfile(self):
        ...
        with open(r'C:\edyoda pr\final_project\details.json', 'r') as file:
        ...
        for credit in credentials:
            if credit['name']==self.name:
                ...
                with open(r'C:\edyoda pr\final_project\details.json','w') as w:
...
if __name__ == "__main__":
    user_operations = user_operation("pallavi")